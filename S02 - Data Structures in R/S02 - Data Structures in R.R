...
### - --- ----------------------------------------------------------------------------------
### ---   SESSION 02: INTRODUCTION TO DATA STRUCTURES IN R
### - --- ----------------------------------------------------------------------------------
### - --- Autumn 2018.
...
typeof(num_vect)
mode(num_vect)
# - note: difference between class(), mode(), and typeof():
...
num_vect_2[3:length(num_vect_2)]
...
# - note: learn about match() too, 
# - https://www.rdocumentation.org/packages/base/versions/3.5.1/topics/match
test_2
...
# - Never forget about RECYCLING in R:
n1 <- c(1, 2, 3)
n1
n2 <- c(4, 5, 6, 7)
n2
